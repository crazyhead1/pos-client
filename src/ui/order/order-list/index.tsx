...
const OrderList: React.FC<ComponentProps> = (props) => {
  ...
  const handleUpdate = (updatedProduct: any) => {
    ...
    editProductFromOrder(updatedProduct.id, updatedProduct)
      .then((res) => {
      ...
      >
        ...
        <Modal.Body>
          <div className={classes.modalBodyWrapper}>
            <OrderForm product={selectedProduct} onSubmit={handleUpdate} />
          </div>
        </Modal.Body>
      </Modal>
    </>
